...
export class Employeedetails1 extends Component {
    constructor(props) {
        super(props)
    ...
    handleApprove=e =>{
      axios.get('https:/digihr-api.appspot.com/api/update/taskRequest/',
      {
          params: {
    ...
    handleReject=e =>{
      axios.get('https:/digihr-api.appspot.com/api/cancel/taskRequest/',
      {
          params: {
              taskCode: getCookie('taskCode'),
              dbName:getCookie('dbName')
...
{/*  
    ...
    <Form.Item wrapperCol={{ span: 12, offset: 5 }}>
        <ButtonGroup>
      <Button type="primary" htmlType="submit" onClick={() =>  this.handleApprove()}>APPROVE</Button>
      <Button type="default" onClick={() =>  this.handleReject()}>REJECT</Button>
       </ButtonGroup>
